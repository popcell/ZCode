...
import { parseProxyUrl } from "./httpProxyUrl.js";
...
const httpProxySchema = nonEmptyStringSchema.refine((value) => parseProxyUrl(value) !== undefined, {
  message: "Invalid HTTP/SOCKS5 proxy URL",
});
